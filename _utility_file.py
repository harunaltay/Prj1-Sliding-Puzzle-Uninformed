...
def create_a_matrix_from_a_text_file(file_name):
    vector_all = create_a_vector_from_a_text_file(file_name)
    matrix_all = make_a_matrix_from_a_list(vector_all)
    return matrix_all
...
if __name__ == '__main__':
    ...
    matrix = create_a_matrix_from_a_text_file(f_name)
    for line in matrix:
        print(line)
