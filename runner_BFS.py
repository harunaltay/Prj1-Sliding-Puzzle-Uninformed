...
def runner_solver_bfs_main_from_file():
    ...
    if len(sys.argv) != 2:
        print("usage: python runner_BFS.py puzzleX.txt")
        return

    f_name = sys.argv[1]
    print("file:", f_name)

    runner_solver_bfs_main_from_file_name(f_name)


def runner_solver_bfs_main():
    # f_name = 'puzzle-text-files/puzzle2x2-00.txt'
    # f_name = 'puzzle-text-files/puzzle4x4-00.txt'
    # f_name = 'puzzle-text-files/puzzle3x3-00.txt'
    # f_name = 'puzzle-text-files/puzzle3x3-03.txt'
...
def runner_solver_bfs_main_from_file_name(file_name):
    vector, matrix = create_a_vector_and_a_matrix_from_a_text_file(file_name)

    runner_solver_bfs_main_from_the_matrix(matrix)


def runner_solver_bfs_main_from_the_matrix(matrix):
...
if __name__ == '__main__':
    runner_solver_bfs_main_from_file()
